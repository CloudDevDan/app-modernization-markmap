...
html = html.replace(
  /<title>.*?<\/title>/,
  '<title>Dan’s Microsoft App Modernization Markmap</title>'
);
...
<div id="headerWrapper">
  ...
  ">
    ...
    <p style="margin-top: 0.5rem; font-size: 0.95rem; color: #666;">
      ...
      |&nbsp;
      <a href="https://github.com/CloudDevDan/app-modernization-markmap" target="_blank" style="color: #4da6ff; text-decoration: none;">
        Project repo →
      </a>
    </p>
